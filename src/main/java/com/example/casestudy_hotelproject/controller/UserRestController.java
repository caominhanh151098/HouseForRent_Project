...
public class UserRestController {
    ...
    @GetMapping("/client/detail/review/by-guest")
    public Page<ShowReviewHostDetailResponse> getReviewDetailByGuest( @SortDefault(sort = "reviewDate", direction = Sort.Direction.DESC) @PageableDefault(size = 10) Pageable pageable) {
        User user =userService.getCurrentUser();
        return reviewService.getReviewDetailByGuest(user.getId(), pageable);
    }
